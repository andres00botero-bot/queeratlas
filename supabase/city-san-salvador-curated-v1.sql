...
[
  {
    ...
    "hours": "Evening / late-night venue. Public hours are not reliably published; verify current same-day hours before visiting.",
  ...
  },
  {
    ...
    "hours": "Area active daily; individual restaurants, bars and hotels set their own hours. Use direct rides after dark.",
  ...
  },
  {
    ...
    "hours": "Tue-Sun 10:00-18:00; Mon closed. Verify current exhibitions and holiday hours before visiting.",
    "link": "https://museomarte.org/",
  ...
  },
  {
    ...
    "hours": "Mon-Fri 8:00-12:00 and 14:00-16:30; Sat 8:00-12:00. Sat afternoon, Sun and holidays by prior reservation only.",
  ...
  },
  {
    ...
    "hours": "Hotel open 24 hours daily; check-in and check-out follow the booking confirmation.",
  ...
  {
    "name": "Barcelo San Salvador",
    "city": "san_salvador",
    "type": "hotel",
    "description": "Large San Benito / Zona Rosa hotel anchor with restaurants nearby and strong logistics for LGBTQ travelers who want a clear pickup point, business-hotel services and direct night transport.",
    "vibe": "Zona Rosa hotel anchor with reliable visitor logistics",
    "hours": "Hotel open 24 hours daily; check-in and check-out follow the booking confirmation.",
    "link": "https://www.barcelo.com/en-us/barcelo-san-salvador/",
  ...
  },
  {
    ...
    "hours": "Restaurant / bar hours vary by branch and day; verify same-day before visiting.",
  ...
  },
  {
    ...
    "hours": "Public opening hours are not reliably published by the listing source; verify same-day before visiting.",
