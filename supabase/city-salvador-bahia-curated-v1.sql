...
from (
  values
    (
      ...
      array[]::text[],
      'Mon 23:00-03:00; Tue-Fri 20:00-03:00; Sat 23:00-03:00; Sun 23:00-00:00. Verify current programming before visiting.',
    ...
    (
      ...
      array[]::text[],
      'Wed 21:00-02:00; Thu 21:00-03:00; Fri-Sat 21:00-04:00; Sun 21:00-03:00; Mon-Tue closed. Verify current hours before visiting.',
    ...
    (
      ...
      array[]::text[],
      'Fri-Sat 23:00-06:00. Verify current event calendar before visiting.',
      '',
    ...
    (
      ...
      array[]::text[],
      'Thu-Sat 22:30-06:00. Verify current event calendar before visiting.',
      '',
    ...
    (
      ...
      array[]::text[],
      'Fri-Sat 23:00-06:00. Verify current opening before visiting.',
    ...
    (
      ...
      array[]::text[],
      'Thu-Sat from about 22:00 until close. Verify current hours before visiting.',
    ...
    (
      ...
      array[]::text[],
      'Evenings Wed-Sun; verify current schedule before visiting.',
    ...
    (
      ...
      array[]::text[],
      'Tue-Sun 15:00-22:00; Mon closed. Verify current hours before visiting.',
      '',
    ...
    (
      ...
      array[]::text[],
      'Mon-Fri 15:00-20:30; Sat-Sun 15:00-21:00. Verify current events before visiting.',
      '',
    ...
    (
      ...
      array[]::text[],
      'Daily about 09:00-19:00. Verify current hours before visiting.',
...
from (
  values
    ...
    (
      ...
      array[]::text[],
      'Curated Salvador cultural research',
      '2026-06-20'::date,
      true
    )
) as v(
