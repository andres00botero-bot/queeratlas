...
export default function sitemap() {
  ...
  const eventEntityEntries = [...bolognaSeedEvents, ...creteSeedEvents, ...cyprusSeedEvents, ...chiangMaiSeedEvents, ...kohSamuiSeedEvents, ...ljubljanaSeedEvents, ...marseilleSeedEvents, ...ottawaSeedEvents, ...belfastSeedEvents, ...seedEvents]
  ...
  const venueEntityEntries = [...bolognaSeedPlaces, ...creteSeedPlaces, ...cyprusSeedPlaces, ...chiangMaiSeedPlaces, ...kohSamuiSeedPlaces, ...ljubljanaSeedPlaces, ...marseilleSeedPlaces, ...ottawaSeedPlaces, ...belfastSeedPlaces, ...seedPlaces]
