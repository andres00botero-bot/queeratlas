...
import { belfastSeedEvents, belfastSeedPlaces } from "@/lib/seed/regions/belfast";
import { johannesburgSeedEvents, johannesburgSeedPlaces } from "@/lib/seed/regions/johannesburg";
...
export default function sitemap() {
  ...
  const eventEntityEntries = [...bolognaSeedEvents, ...creteSeedEvents, ...cyprusSeedEvents, ...chiangMaiSeedEvents, ...kohSamuiSeedEvents, ...ljubljanaSeedEvents, ...marseilleSeedEvents, ...ottawaSeedEvents, ...belfastSeedEvents, ...johannesburgSeedEvents, ...seedEvents]
  ...
  const venueEntityEntries = [...bolognaSeedPlaces, ...creteSeedPlaces, ...cyprusSeedPlaces, ...chiangMaiSeedPlaces, ...kohSamuiSeedPlaces, ...ljubljanaSeedPlaces, ...marseilleSeedPlaces, ...ottawaSeedPlaces, ...belfastSeedPlaces, ...johannesburgSeedPlaces, ...seedPlaces]
