...
export default function PageControls({
  ...
  return (
    <section className={`relative overflow-hidden rounded-[20px] border border-cyan-200/26 bg-[radial-gradient(circle_at_12%_0%,rgba(34,211,238,0.15),transparent_34%),radial-gradient(circle_at_88%_10%,rgba(244,114,182,0.14),transparent_32%),linear-gradient(180deg,rgba(13,17,28,0.97),rgba(8,8,12,0.99))] p-2 shadow-[0_24px_72px_rgba(0,0,0,0.42),0_0_0_1px_rgba(244,114,182,0.08),0_18px_54px_rgba(34,211,238,0.08)] backdrop-blur-xl sm:rounded-[26px] sm:p-3.5 ${isFavoritesDesktopLuxe ? "sm:border-fuchsia-200/24 sm:bg-[radial-gradient(circle_at_12%_0%,rgba(168,85,247,0.15),transparent_34%),radial-gradient(circle_at_88%_10%,rgba(244,114,182,0.12),transparent_32%),linear-gradient(180deg,rgba(15,13,22,0.98),rgba(8,8,11,0.99))] sm:p-4 sm:shadow-[0_22px_64px_rgba(0,0,0,0.42),0_16px_46px_rgba(168,85,247,0.10)]" : ""} ${className}`}>
