        ...
        {tonightFeedTab === "public" ? (
          isMember ? (
            <button
              ...
              className="qa-cinematic-hover qa-action qa-action-strong qa-city-cta-primary rounded-full border border-fuchsia-200/40 bg-[linear-gradient(135deg,rgba(232,121,249,0.26),rgba(99,102,241,0.2),rgba(14,10,20,0.94))] px-4 py-2 text-xs font-semibold text-fuchsia-50 transition hover:border-fuchsia-200/62"
            >
              Host private plan
            </button>
          ) : (
