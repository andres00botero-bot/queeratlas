...
const RAW_PILOT_PROFILES = [
  ...
  },
  {
    ...
    qariScore: 22,
    confidence: "high",
    summary: "Germany has a strong legal base and major queer hubs, but the documented rise in anti-queer offences and attacks around Pride events warrants moderate awareness.",
    reviewedAt: "2026-08-18",
    sources: [
